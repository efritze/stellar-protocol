...
Author: Fritz Ekwoge, Ernest Mbenkum
Status: Draft
Created: 2019-11-22
Updated: 2019-11-22
Version: 0.0.1
...
Certain anchors may provide users the option to  deposit or withdraw assets in and out of the Stellar network directly from their wallets. For such assets, the `transaction_protocols` field is an array listing all transfer protocols the anchor supports for that asset. 
